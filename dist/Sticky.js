...
var Sticky = (function (_Component) {
    ...
    _createClass(Sticky, [{
        ...
        value: function getBottomPosition(bottom) {
            // TODO, topTarget is for current layout, may remove
            // a top argument can be provided to override reading from the props
        ...
        key: 'getTargetBound',
        value: function getTargetBound(target) {
            var type = arguments.length <= 1 || arguments[1] === undefined ? 'bottom' : arguments[1];
        ...
        key: 'getBoundary',
        value: function getBoundary(boundary) {
            var type = arguments.length <= 1 || arguments[1] === undefined ? 'bottom' : arguments[1];
        ...
        value: function update() {
            ...
            if (top <= this.state.topBoundary) {
                ...
                if (!this.props.stickToBottom && this.state.height > winHeight - this.state.top || this.props.stickToBottom && this.state.bottomBoundary - winHeight < window.pageYOffset) {
...
Sticky.propTypes = {
    ...
    topBoundary: _propTypes2['default'].oneOfType([_propTypes2['default'].object, // TODO, may remove
